...
def naselje_obrazac(naselje_id):
    ...
    if request.method == "POST":
        ...
        if not drzava:
            error_message = "Država nije pronađena."
        else:
            ...
            if koordinate and len(koordinate) > 0:
                ...
                error_message = "Koordinate za uneseno naselje nisu pronađeni. Molimo pokušajte ponovno ili unesite drugačiji naziv."
    ...
    return render_template("naselje_obrazac.html", naselje=naselje, dostupne_drzave=dostupne_drzave, error_message=error_message)
...
def prikaz_vremena(naselje_id, drzava_id):
    ...
    if naselje and drzava:
        latitude = naselje.Zemljopisna_sirina
        longitude = naselje.Zemljopisna_duzina
        ...
        if latitude and longitude:
            ...
            if weather_response.status_code == 200:
                ...
                error_message = 'Nije moguće dohvatiti podatke o vremenskim uvjetima za odabranu lokaciju.'

    return render_template('prikaz_vremena.html', weather_data=weather_data, naselje=naselje, drzava=drzava, error_message=error_message)
    ...
    if naselje and drzava:
        ...
        if latitude and longitude:
            ...
            if weather_response.status_code == 200:
                ...
                error_message = 'Nije moguće dohvatiti podatke o kvaliteti zraka za odabranu lokaciju.'

    return render_template('kvaliteta_zraka.html', weather_data=weather_data, naselje=naselje, drzava=drzava, error_message=error_message)
...
def informacije_naselja(naselje_id, drzava_id):
    ...
    if not naselje:
        error_message = 'Naselje nije pronađeno.'
    elif not drzava:
        error_message = 'Država nije pronađena.'

    return render_template('informacije_naselja.html', naselje=naselje, drzava=drzava, error_message=error_message)
